Feature: Making a shelf from several pieces
  ...
  As a carpenter
  I want to take pieces from my inventory and cut them to size, yet maximizing the remaining inventory
  ...
  Scenario: Making a shelf from 2 pieces in the inventory
    Given some pieces in the inventory that measure:
      | 20 |
      | 25 |
    When I make a shelf that measures "35"
    Then I should have pieces that measure:
      | 25 |
      | 10 |
  ...
  Scenario: Making a shelf from many pieces in the inventory
    ...
    Then I should have pieces that measure:
      ...
      | 13 |
      |  9 |
    And I should have pieces left in the inventory that measure:
      | 25 |
      | 10 |
      |  3 |
